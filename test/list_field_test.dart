...
void main() {
  test('Basic ListField validates itself', () {
    ...
    expect(invalidRes3.description, 'Expected type List<dynamic> but found int');
  ...
  test('Basic ListField validates items', () {
    ...
    expect(invalidRes1.isValid, false);
    expect(invalidRes1.description, '[0]: Expected type int but found String');
  });
  ...
  test('Nested ListField validates items', () {
    ...
    expect(invalidRes2.isValid, false);
    expect(invalidRes2.description, '[0][1]: Expected type int but found String');
  });
  ...
  test('Map ListField', () {
    ...
    expect(invalidRes1.isValid, false);
    expect(invalidRes1.description, '[0].city: Expected type String but found Null, [0].street: Expected type String but found Null');
  });
}
