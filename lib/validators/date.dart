...
IValidator isDateBefore(DateTime dt, {bool inclusive = false}) => Validator((value) {
...
IValidator isDateAfter(DateTime dt, {bool inclusive = false}) => Validator((value) {
...
IValidator isDateSameDay(DateTime dt) => Validator((value) {
      final ok = value is DateTime &&
          value.year == dt.year &&
...
IValidator isDateInPast({bool allowNow = true}) {
...
IValidator isDateInFuture({bool allowNow = true}) {
  final now = DateTime.now();
  return Validator((value) {
